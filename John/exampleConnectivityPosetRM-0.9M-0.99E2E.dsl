...
8	wait(#0)	if !has(F0: A -> B) pull(F0: A -> B, #0) else if has(F0: B -> C) push(F0: B -> C, #0)	wait(#0)
...
16	sleep	if has(F0: B -> C) push(F0: B -> C, #0)	wait(#0)
17	sleep	if !has(F1: C -> B) pull(F1: C -> B, #0)	wait(#0)
...
25	wait(#0)	if !has(F1: C -> B) pull(F1: C -> B, #0) else if has(F1: B -> A) push(F1: B -> A, #0)	wait(#0)
...
33	wait(#0)	if has(F1: B -> A) push(F1: B -> A, #0)	sleep
