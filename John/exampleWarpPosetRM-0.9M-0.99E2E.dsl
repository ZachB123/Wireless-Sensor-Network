...
5	if has(F0: A -> B) push(F0: A -> B, #0)	wait(#0)	sleep
6	sleep	wait(#0)	if !has(F0: B -> C) pull(F0: B -> C, #0)
...
11	sleep	wait(#0)	if !has(F0: B -> C) pull(F0: B -> C, #0)
12	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0)
13	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0)
14	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0)
...
17	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0)
18	if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
19	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
20	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
21	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
22	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
23	if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
