...
nChannels: 16
Time Slot	A	B	C
0	push(F0: A -> B, #7)	wait(#7)	sleep
1	push(F0: A -> B, #8)	wait(#8)	sleep
2	sleep	push(F0: B -> C, #14)	wait(#14)
3	sleep	push(F0: B -> C, #15)	wait(#15)
4	sleep	wait(#7)	push(F1: C -> B, #7)
5	sleep	wait(#8)	push(F1: C -> B, #8)
6	wait(#0)	push(F1: B -> A, #0)	sleep
7	wait(#1)	push(F1: B -> A, #1)	sleep
8	sleep	sleep	sleep
9	sleep	sleep	sleep
