...
public class Program implements SystemAttributes {
	...
	private Integer findNextAvailableInstructionTimeSlot(ProgramSchedule schedule, Integer startLocation,
			Integer nodeInFlow, Integer transIndex, Integer nTx, Integer[] previousNodeInstruction,
			Integer[] currentNodeInstruction, String sleepInstruction, Boolean realtimeHART,
			Boolean optimizationRequested, Integer srcNodeIndex, Integer snkNodeIndex) {
	...
	private Boolean slotIsAvailable(InstructionTimeSlot currentInstructionTimeSlot, Integer srcNodeIndex,
	...
	/**
	 * <h1>Returns the schedule for the networks messages.</h1>
	 * 
